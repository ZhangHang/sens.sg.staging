...
- 短信分为「验证码」和「推广短信」，后者比前者贵几分钱/条
- 如果国外服务有问题，国内的短信平台限制如下
    - 国内的短信平台只能发到国内，不包含港澳台。
    - 国内短信平台模版修改需要在平台内部进行，无法在我们的后台修改
...
- 手机端：导航展开后底色的蓝色需要改
- 手机端：所有的白色框需要调整视觉效果
- 重要消息在首页也展示，参照手机端手机，点一次关闭
- 需要设计平衡消息提示条的视觉效果，降低营销感
- 手机端：学员中心放到左侧导航栏中
- 桌面端：学员中心也默认展示出来
- 点击学员中心没有登陆，自动跳转到登陆/注册页
- 手机端：未登陆小人用粉色线条
- 桌面端：也用卡片风格的学员列表（第一次引导，学员中心）
- 桌面端：学员总览的卡片，采用竖排，和手机端保持相同设计
- 「还有待录入体检报告的学员」提示的「稍后填写」按钮变为文字按钮，字变小

- 手机端扫描二维码流程：「复制并开始注册」变成文字按钮
- 手机端扫描二维码流程：邀请码输入框文案改为「粘贴邀请码」
- 手机端扫描二维码流程：扫描邀请码的白色框也和上面一样，调整一下

- 桌面端：账户顶条儿的导航栏背景改为「渐变色」
- Logo 用加 TM 的
- 首页整体选择白色的版本
- 首页的声波太扎人，需要改进，降低密度不用越来越高
- 课程设计思路：有一个渐渐清晰，感官优化，感知更敏锐的感觉
- 登陆设计往首页靠靠，比如背景采用「模糊到清晰的背景图片」